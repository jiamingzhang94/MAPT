...
class SimpleTrainer(TrainerBase):
    ...
    def test_adv(self, surrogate, split=None):
        ...
        # self.model.build_eval_surrogate(surrogate)
        ...
        for batch_idx, batch in enumerate(tqdm(data_loader)):
            ...
            output = self.model_inference_adv(input, label)
    ...
    def model_inference_adv(self, input, label):
        return self.model.forward_adv(input, label)
